  ...
  /*       $file_path=__DIRART__.$datetime.$uid.'article.html';
    ...
    public function newVote(){
      ...
      /*   $file_path=__DIRART__.$datetime.$uid.'vote.html';
         ...
         *///
        $sql="insert into". __PREFIX__."vote(id,title,,begtime,endtime,uid,tid,options,grade) values (
        $id,'$title','$datesql','$enddatesql',$uid,$tid,'$option','$grade')";
